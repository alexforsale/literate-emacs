...
#+end_src
*** eshell-syntax-highlighting :archive:
...
#+end_src
*** git-messenger :external:archive:
...
#+end_src
*** git-timemachine :external:archive:
...
#+end_src
*** treemacs-projectile :archive:
#+name: treemacs-projectile
#+begin_src emacs-lisp
  (use-package treemacs-projectile
    :after treemacs projectile)
#+end_src
*** treemacs-icons-dired :archive:
...
#+end_src
*** treemacs-magit :archive:
#+name: treemacs-magit
#+begin_src emacs-lisp
  (use-package treemacs-magit
    :after treemacs magit)
#+end_src
*** treemacs-evil :archive:
#+name: treemacs-evil
#+begin_src emacs-lisp
  (use-package treemacs-evil
    :after treemacs evil)
#+end_src
*** lsp-treemacs :archive:
...
*** notmuch-indicator :external:archive:
:PROPERTIES:
:header-args: :tangle no
:END:
...
#+end_src
*** consult-notmuch :external:archive:
:PROPERTIES:
:header-args: :tangle no
:END:
...
#+end_src
*** notmuch-maildir :external:archive:
:PROPERTIES:
:header-args: :tangle no
:END:
