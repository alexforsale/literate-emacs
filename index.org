...
(use-package exwm
  ...
  (defun +config-exwm--init-hook ()
    ...
    (+config-exwm--run-in-background "~/.local/bin/monitor-setup")
    ...
    (+config-exwm--run-in-background "nm-applet")
    (+config-exwm--run-in-background "iwgtk -i")
    (+config-exwm--run-in-background "/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1")
    ...
    (+config-exwm--run-in-background "light-locker")
