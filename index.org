...
#+end_src
*** Keybinding
Most keybindings here depends on [[id:76f56dc0-309f-485d-b9b6-70971e90437d::evil][evil]], so it will be loaded after.
#+begin_src emacs-lisp
...
#+end_src
*** gptel :external:noexport:disabled:archive:
#+name: gptel
#+begin_src emacs-lisp :tangle no
  (use-package gptel
