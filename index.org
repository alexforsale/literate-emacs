...
*** [[https://github.com/rgrinberg/evil-quick-diff][evil-quick-diff]]                             :external:archive:noexport:
...
#+end_src
*** [[https://github.com/noctuid/evil-textobj-anyblock][evil-textobj-anyblock]]                       :external:archive:noexport:
...
#+begin_src emacs-lisp
  (use-package evil-vimish-fold
    ...
    ;; (evil-define-key '(normal visual) 'global (kbd "zF") (cons "vimish-fold" my/vimish-fold-map))
    ;; (evil-define-key nil my/vimish-fold-map
    ;;   "j" '("next fold" . vimish-fold-next-fold)
    ;;   "k" '("prev fold" . vimish-fold-previous-fold)
    ;;   "d" '("delete" . evil-vimish-fold/delete)
    ;;   "E" '("delete all" . evil-vimish-fold/delete-all))
    )
#+end_src
*** [[https://github.com/gabesoft/evil-mc/][evil-mc]] :external:
Multiple cursors implementation for =evil-mode=. I'm using the default prefix ~g .~. Considering to disable this in favor for /evil-multiedit/.
#+begin_src emacs-lisp
  (use-package evil-mc
    :ensure t
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    ...
    (evil-set-leader '(insert emacs) (kbd "C-c SPC")))
#+end_src
*** 1st level commands
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    ...
    (evil-define-key* '(normal visual) 'global (kbd "<leader>c") (cons "Chat" my/c-map))
    (with-eval-after-load 'org
      (evil-define-key* nil my/c-map "c" '("org-capture" . org-capture)))
    (setq my/gptel-map (make-sparse-keymap))
    (with-eval-after-load 'gptel
      (evil-define-key* nil my/c-map "g" (cons "Gptel" my/gptel-map))
      (evil-define-key nil my/gptel-map "a" '("Add/remove region" . gptel-add))
      (evil-define-key nil my/gptel-map "g" '("gptel" . gptel))
      (evil-define-key nil my/gptel-map "G" '("gptel-menu" . gptel-menu))
      (evil-define-key nil my/gptel-map "s" '("send" . gtpel-send))))
#+end_src
*** Buffers
...
#+end_src
*** Filetree
This is for /treemacs/ ~<leader>e~, would be good for /dired/ also.
#+name: tree
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    (setq my/tree-map (make-sparse-keymap))
    (evil-define-key* '(normal visual) 'global (kbd "<leader>e") (cons "Tree" my/tree-map)))
#+end_src
*** Files
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    (setq my/git-map (make-sparse-keymap))
    (with-eval-after-load 'magit
      (evil-define-key* '(normal visual) 'global (kbd "<leader>g") (cons "Git" my/git-map))))
#+end_src
*** Help
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    ...
    (evil-define-key* '(normal visual) 'global (kbd "<leader>i") (cons "Insert" my/insert-map))
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    (setq my/haskell-map (make-sparse-keymap))
    (with-eval-after-load 'haskell-mode
      (evil-define-key* '(normal visual) haskell-mode-map (kbd "<leader>m") (cons "haskell-mode" my/haskell-map))))
#+end_src
**** ocaml 
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    (setq my/ocaml-map (make-sparse-keymap))
    (with-eval-after-load 'tuareg
      (evil-define-key* '(normal visual) tuareg-mode-map (kbd "<leader>m") (cons "ocaml" my/ocaml-map))))
#+end_src
**** zig
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    (setq my/zig-map (make-sparse-keymap))
    (with-eval-after-load 'zig-mode
      (evil-define-key* '(normal visual) zig-mode-map (kbd "<leader>m") (cons "zig" my/zig-map))))
#+end_src
**** go
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    (setq my/golang-map (make-sparse-keymap))
    (with-eval-after-load 'go-mode
      (evil-define-key* '(normal visual) go-mode-map (kbd "<leader>m") (cons "golang" my/golang-map))))
#+end_src
*** Open/org
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil 
    ...
    (evil-define-key* '(normal visual) 'global (kbd "<leader>o") (cons "Open" my/open-map))
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    ...
    (evil-define-key* '(normal visual) 'global (kbd "<leader>s") (cons "Search" my/search-map)))
#+end_src
*** Tab 
#+name: Tab 
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    ...
    (evil-define-key* '(normal visual) 'global (kbd "<leader>t") (cons "Tab" my/tab-map)))
#+end_src
*** Terminal
Sets to ~<leader>v~ since I mostly only use /vterm/.
#+name: term
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    ...
    (evil-define-key* '(normal visual) 'global (kbd "<leader>w") (cons "Window" my/window-map))
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    (defvar my/window-map-repeat-map
      (let ((map (make-sparse-keymap)))
        ...
        map)
      "Keymap for my/window-map repeat")
    (put 'evil-window-down 'repeat-map 'my/window-map-repeat-map)
    (put 'evil-window-up 'repeat-map 'my/window-map-repeat-map)
    (put 'evil-window-right 'repeat-map 'my/window-map-repeat-map)
    (put 'evil-window-left 'repeat-map 'my/window-map-repeat-map)
    (put 'evil-window-rotate-upwards 'repeat-map 'my/window-map-repeat-map)
    (put 'evil-window-rotate-downwards 'repeat-map 'my/window-map-repeat-map))
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    ...
    (evil-define-key* '(normal visual) 'global (kbd "<leader>q") (cons "Quit" my/quit-map))
...
**** dired :noexport:archive:disabled:
#+name: dired
#+begin_src emacs-lisp :tangle no
  (evil-define-minor-mode-key '(normal visual) 'dired-mode-map
    (kbd "g$") '("hide subdir" . dired-hide-subdir)
    (kbd "g?") '("summary" . dired-summary)
    (kbd "gG") '("change group" . dired-do-chgrp)
    (kbd "gj") '("next dir line" . dired-next-dirline)
    (kbd "gk") '("prev dir line" . dired-prev-dirline)
    (kbd "go") '("view file" dired-view-file)
    (kbd "gy") '("show file type" . dired-show-file-type))
#+end_src
*** footer :noexport:
#+begin_src emacs-lisp
...
** general :external:noexport:archive:
:PROPERTIES:
...
#+name: ace-window
#+begin_src emacs-lisp :tangle no
  (use-package posframe :ensure t :demand t)
...
#+begin_src emacs-lisp
  (use-package dashboard
    ...
    (setq initial-buffer-choice (lambda () (get-buffer-create dashboard-buffer-name))
                                 ...
                                 dashboard-heading-icons '((bookmarks . "nf-oct-bookmark")
...
#+begin_src emacs-lisp
  (use-package helpful
    ...
    (keymap-global-set "C-h F" '("helpful Function" . helpful-function))
    (define-key prog-mode-map (kbd "C-c C-d") '("help at point" . helpful-at-point)))
#+end_src
...
#+begin_src emacs-lisp
  (use-package winner
    ...
    (setq winner-boring-buffers '("*Completions*" "*Compile-Log*" "*inferior-lisp*" "*Fuzzy Completions*"
                                  ...
                                  "*esh command on file*")))
#+end_src
*** [[https://github.com/benma/visual-regexp.el][visual-regexp]] :external:disabled:archive:noexport:
#+begin_src emacs-lisp :tangle no
  (use-package visual-regexp
    ...
    (with-eval-after-load 'general
      (+config/leader-search
        ...
        "/q" 'vr/query-replace)))
#+end_src
*** [[https://github.com/rnkn/olivetti][olivetti]] :disabled:noexport:archive:
...
#+end_src
*** [[https://github.com/wolray/symbol-overlay][symbol-overlay]] :external:archive:disabled:noexport:
...
#+end_src
*** [[https://github.com/hlissner/emacs-solaire-mode][solaire-mode]] :external:
...
#+begin_src emacs-lisp
  (use-package tab-bar
    ...
    (with-eval-after-load 'evil
      (evil-define-key* nil my/tab-map
        "c" '("new tab" . tab-new)
        "d" '("close tab" . tab-close)
        "G" '("group tab" . tab-group)
        "g" '("last tab" . tab-last)
        "n" '("next tab" . tab-next)
        "p" '("prev tab" . tab-previous)
        "r" '("rename tab" . tab-rename)
        "t" '("tab-bar-mode" . (lambda () (interactive) (tab-bar-mode 'toggle)))
        "u" '("undo tab" . tab-undo)))
...
**** vertico
***** Basic configuration :disabled:archive:noexport:
#+name: vertico
#+begin_src emacs-lisp :tangle no
  (use-package vertico
    :ensure (vertico
...
**** [[https://github.com/minad/affe][affe]] :disabled:archive:noexport:
...
#+begin_src emacs-lisp :tangle no
  (use-package jinx
      ...
      (evil-global-set-key 'normal (kbd "C-M-$") 'jinx-language))
#+end_src
**** Snippets
...
#+end_src
**** [[https://github.com/minad/tempel][tempel]] :disabled:noexport:archive:
...
#+end_src
*** eshell-syntax-highlighting :external:noexport:archive:disabled:
...
#+end_src
*** vterm-toggle :external:noexport:disabled:archive:
#+name: vterm-toggle
#+begin_src emacs-lisp :tangle no
(use-package vterm-toggle
  ...
  (add-to-list 'display-buffer-alist
               '((lambda (buffer-or-name _)
                 ...
                 (window-height . 0.4))))
#+end_src
*** bash-completion :external:archive:noexport:
...
#+end_src
*** [[https://github.com/gilbertw1/better-jumper][better-jumper]] :external:
#+begin_src emacs-lisp :tangle no
...
*** [[https://github.com/radian-software/apheleia][apheleia]] :external:archive:noexport:
#+begin_src emacs-lisp :tangle no
...
#+end_src
*** [[https://github.com/magnars/expand-region.el][expand-region]] :external:archive:noexport:
...
#+begin_src emacs-lisp
  (use-package magit
    ...
    (with-eval-after-load 'evil
      ...
      (evil-define-key* nil my/git-map
...
#+begin_src emacs-lisp
  (use-package diff-hl
    ...
    (with-eval-after-load 'evil
      (evil-define-key* '(normal visual) 'global
        "z*" '("show hunk" . diff-hl-show-hunk)
        "z[" '("prev hunk" . diff-hl-previous-hunk)
        "z]" '("next hunk" . diff-hl-next-hunk)
        "z{" '("go and show prev hunk" . diff-hl-show-hunk-previous)
        "z}" '("go and show next hunk" . diff-hl-show-hunk-next))))
#+end_src
...
#+end_src
*** git-link :external:noexport:disabled:archive:
#+name: git-link
#+begin_src emacs-lisp :tangle no
...
#+end_src
*** git-messenger :external:noexport:disabled:archive:
...
#+end_src
*** git-timemachine :external:noexport:disabled:archive:
...
#+end_src
*** org-project-capture :external:noexport:disabled:archive:
...
#+begin_src emacs-lisp :tangle no
  (use-package lsp-mode
    ...
    (evil-define-key 'normal lsp-mode-map (kbd "<leader>l") (cons "LSP" lsp-command-map))
    (evil-define-key 'normal lsp-mode-map "K" '("describe at point" . lsp-describe-thing-at-point))
  ...
  ;; (evil-define-key* '(normal visual) lsp-mode-map (kbd "<leader>l") (cons "LSP" lsp-command-map))
  ;; (evil-define-key* '(normal visual) lsp-mode-map "K" '("describe at point" . lsp-describe-thing-at-point)
#+end_src
**** lsp-ui 
#+begin_src emacs-lisp :tangle no
  (use-package lsp-ui
                 ...
                 `(rust-mode . ("rust-analyzer" :initializationOptions
                                ( :procMacro (:enable t)
                                  :cargo ( :buildScripts (:enable t)
                                           :features "all"))))))
#+end_src
*** [[https://emacs-lsp.github.io/dap-mode/page/configuration/][dap-mode]] :external:archive:disabled:noexport:
#+begin_src emacs-lisp :tangle no
...
*** [[https://github.com/douo/magit-gptcommit][magit-gptcommit]] :noexport:external:disabled:archive:
...
#+end_src
*** [[https://www.flycheck.org/][flycheck]] :external:
#+begin_src emacs-lisp :tangle no
  (use-package flycheck
    ...
    (with-eval-after-load 'evil
      (evil-define-key* '(normal visual) 'global (kbd "<leader>!") (cons "Flycheck" flycheck-command-map))
      (evil-define-key* '(normal visual) flycheck-error-list-mode-map
...
#+end_src
**** [[https://github.com/flycheck/flycheck-color-mode-line][flycheck-color-mode-line]] :external:
#+begin_src emacs-lisp :tangle no
  (use-package flycheck-color-mode-line
    :hook (flycheck-mode . flycheck-color-mode-line-mode))
#+end_src
**** [[https://github.com/flycheck/flycheck-pos-tip][flycheck-pos-tip]] :external:
#+begin_src emacs-lisp :tangle no
...
#+end_src
**** [[https://github.com/flycheck/flycheck-popup-tip][flycheck-popup-tip]] :external:
#+begin_src emacs-lisp :tangle no
  (use-package flycheck-popup-tip
    :commands flycheck-popup-tip-show-popup flycheck-popup-tip-delete-popup
    :hook (flycheck-mode . flycheck-popup-tip-mode))
#+end_src
**** [[https://github.com/alexmurray/flycheck-posframe][flycheck-posframe]] :external:
#+begin_src emacs-lisp :tangle no
...
#+end_src
**** [[https://github.com/minad/consult-flycheck][consult-flycheck]] :external:
#+begin_src emacs-lisp :tangle no
  (use-package consult-flycheck
    :after (consult flycheck)
    :config
    (with-eval-after-load 'evil
      (evil-define-key* nil my/search-map "F" '("Flycheck" . consult-flycheck))))
#+end_src
*** footer :noexport:
#+begin_src emacs-lisp
  (provide 'config-ide)
...
#+end_src
*** org-appear :external:noexport:disabled:archive:
#+begin_src emacs-lisp :tangle no
  (use-package org-appear ; better markup edit
    :hook (org-mode . org-appear-mode))
#+end_src
*** [[https://github.com/rexim/org-cliplink][org-cliplink]] :external:noexport:disabled:archive:
#+begin_src emacs-lisp :tangle no
...
#+end_src
*** direnv :noexport:disabled:archive:
*** ox-hugo                                                      :external:
Blogging tools
#+name: ox-hugo
#+begin_src emacs-lisp
  (use-package ox-hugo
    ...
    :after ox)
#+end_src
*** [[https://github.com/purcell/exec-path-from-shell][exec-path-from-shell]]                                 :archive:noexport:
#+begin_src emacs-lisp :tangle no
...
#+end_src
*** [[https://gitlab.com/hperrey/khalel/][Khalel]]                                                       :external:
...
#+end_src
=khalel-import-org-file= should be on the list of =org-agenda-files=.
**** Vdirsyncer
First you'll need to setup a new project in [[https://console.developers.google.com/][Google API Manager]], this is needed for the vdirsyncer configuration, see their [[https://vdirsyncer.pimutils.org/en/stable/config.html#google][configuration manual]] for further information. From this you'll get the /Client ID/ and /Client Secret/.

The configuration file should be placed in ~~/.config/vdirsyncer/config~
#+name: example vdirsyncer google configuration
#+begin_src conf :tangle no
  ...
  #password =
#+end_src
/Vdirsyncer/ is packaged in /archlinux's extra/ repository, and it comes with a user systemd unit file, after running =vdirsyncer discover=, enable the unit file with =systemctl --user enable vdirsyncer.timer=.
**** Khal
Next is the =khal= configuration. This should be placed in ~~/.config/khal/config~:
...
#+begin_src conf :tangle no
  ...
  default_calendar = *
#+end_src
*** [[https://github.com/DamienCassou/khardel][khardel]]                                                      :external:
Emacs package integrating [[https://github.com/lucc/khard?tab=readme-ov-file][khard]], a console cardav client.
#+begin_src emacs-lisp
  (use-package khardel
    :ensure t
    ...
    :config
    (with-eval-after-load 'evil
      (evil-define-key* nil my/insert-map "e" '("insert email" . khardel-insert-email))))
#+end_src
**** khard configuration
This is taken from the [[https://github.com/lucc/khard/blob/main/doc/source/examples/khard.conf.example][example configuration]]. Should be placed in ~~/.config/khard/khard.conf~
#+name: khard configuration
#+begin_src conf :tangle no
  ...
  skip_unparsable = no
#+end_src
All the paths should reflect the configuration on =vdirsyncer=. See the [[https://khard.readthedocs.io/en/latest/][online documentation]] for more information.
*** fzf
#+name: fzf
#+begin_src emacs-lisp
  (use-package fzf
...
#+begin_src emacs-lisp
  (use-package treemacs
    ...
    :config
    (with-eval-after-load 'evil
      (evil-define-key* nil my/tree-map "e" '("treemacs" . treemacs))
      (evil-define-key nil treemacs-mode-map
...
#+begin_src emacs-lisp
  (use-package treemacs-evil
    ...
    :after treemacs evil)
#+end_src
*** lsp-treemacs :external:archive:noexport:
...
#+end_src
*** treemacs-nerd-icons :external:noexport:archive:disabled:
...
:END:
For the longest time I've been using /notmuch/ and /msmtp/ in my email setup. For now I'm looking for a simpler solution since it's kind of a hassle setting up notmuch and msmtp in all of my machines, would also prefer a built-in package. For now I'm trying [[https://www.gnu.org/software/emacs/manual/html_node/gnus/][gnus]]. Gnus also have it's own separate configuration file (~~/.gnus.el~) and login credentials in ~~/.authinfo.gpg~.
*** Example .gnus.el
#+begin_src emacs-lisp :tangle no
  (require 'gnus)
  (require 'gnus-msg)
  ...
  (setq gnus-posting-styles
        '((".*" ; Matches all groups of messages
           (address "Kristian Alexander P <alexarians@gmail.com>")
           ("X-Message-SMTP-Method" "smtp smtp.gmail.com 587 alexarians@gmail.com"))
          ("yahoo" ; Matches Gnus group called "yahoo", probably need to edit this
           (address "Kristian Alexander P <alexforsale@yahoo.com>")
           ("X-Message-SMTP-Method" "smtp smtp.mail.yahoo.com 587 alexforsale@yahoo.com"))))

  ;; remove auto-expire
  (remove-hook 'gnus-summary-prepare-hook 'gnus-summary-expire-articles)
#+end_src
For the ~.authinfo.gpg~ files:
#+begin_src emacs-lisp :tangle no
  machine yahoo login alexforsale@yahoo.com port imaps password *******
  machine gmail login alexarians@gmail.com port imaps password ********
#+end_src
*** header :noexport:
#+begin_src emacs-lisp :tangle no
...
**** clojure :archive:noexport:
***** clojure-mode :external:
#+begin_src emacs-lisp :tangle no
...
#+begin_src emacs-lisp
  (use-package css-mode
    ...
    :config
    (with-eval-after-load 'tree-sitter
      (add-hook 'css-mode-local-vars-hook #'tree-sitter))
...
#+end_src
**** pydoc :external:noexport:archive:disabled:
#+begin_src emacs-lisp :tangle no
  (use-package pydoc
    :config
    (with-eval-after-load 'general
...
#+end_src
**** ob-ipython :external:noexport:archive:disabled:
#+name: ob-ipython
#+begin_src emacs-lisp :tangle no
...
#+end_src
**** pip-requirements :external:disabled:noexport:archive:
...
#+begin_src emacs-lisp
  (use-package python
    ...
    :config
    (setq my/python-map (make-sparse-keymap))
    (evil-define-key* '(normal visual) python-mode-map (kbd "<leader>m") (cons "Python" my/python-map))
    (evil-define-key* nil my/python-map
...
#+end_src
**** pipenv :external:disabled:archive:noexport:
#+name: pipenv
#+begin_src emacs-lisp :tangle no
  (use-package pipenv
    :diminish
...
#+end_src
**** pyvenv :external:disabled:noexport:archive:
#+begin_src emacs-lisp :tangle no
  ;; (use-package pyvenv
  ;;   :after python
  ;;   :demand t
  ...
  (use-package pyvenv
    ...
    (add-to-list 'global-mode-string
                 ...
                 'append))
#+end_src
**** pyimport :external:disabled:noexport:archive:
#+begin_src emacs-lisp :tangle no
...
#+end_src
**** py-isort :external:noexport:disabled:archive:
#+begin_src emacs-lisp :tangle no
  (use-package py-isort
    ...
    (with-eval-after-load 'general
      (+config/local-leader
        ...
        "ir" 'py-isort-region)))
#+end_src
**** python-pytest :external:noexport:archive:disabled:
#+begin_src emacs-lisp :tangle no
...
#+end_src
**** poetry :external:noexport:archive:disabled:
#+begin_src emacs-lisp :tangle no
  (use-package poetry
    :after python
    :init
...
#+end_src
**** pyenv :external:noexport:archive:disabled:
#+begin_src emacs-lisp :tangle no
  (use-package pyenv
    :after python
    :config
...
#+end_src
**** ein :external:noexport:archive:disabled:
#+name: ein
#+begin_src emacs-lisp :tangle no
  (use-package ein)
#+end_src
*** Rust
**** rust-mode :noexport:disabled:archive:
#+name: rust-mode
#+begin_src emacs-lisp :tangle no
  ;;;###autoload
...
#+name: rustic
#+begin_src emacs-lisp
  ;; need external package tree-sitter-rust
  ...
  (with-eval-after-load 'rust-ts-mode
    (setq rust-ts-mode-prettify-symbols-alist
          '(("&&" . "⟑") ("||" . "⟇") ("<=" . "≤") (">=" . "⪭") ("!=" . "≠")
            ("INFINITY" . "∞ " ) ("->" . "→ " ) ("=>" . "⇨ ") ("<=" . "← "))))
  ...
  (use-package rustic
    ...
    (with-eval-after-load 'treesit
      (add-hook 'rustic-mode-hook #'treesit-inspect-mode))
...
#+end_src
**** flycheck-rust :external:archive:noexport:
#+name: flycheck-rust
#+begin_src emacs-lisp :tangle no
...
#+end_src
*** Ansible :noexport:archive:disabled:
**** ansible :external:
#+name: ansible
#+begin_src emacs-lisp :tangle no
  (use-package ansible
...
#+begin_src emacs-lisp
  ...
  (evil-define-key* nil my/haskell-map
    "c" '("compile" . haskell-compile)
    "d" '("describe" . haskell-describe)
    "h" '("search hoogle" . haskell-hoogle)
    "l" '("load and run" . haskell-load-and-run)
    "r" '("run haskell" . run-haskell))
#+end_src
*** Ron-mode :noexport:archive:
#+begin_src emacs-lisp :tangle no
  (use-package ron-mode)
#+end_src
*** yuck-mode :noexport:disabled:archive:external:
#+begin_src emacs-lisp :tangle no
  (use-package yuck-mode)
#+end_src
*** java :external:noexport:archive:
...
#+begin_src emacs-lisp
  ;; opam site lisp
  ;; install `tuareg' using `opam': opam install tuareg
  ;; `merlin' need to be installed by `opam': opam install merlin
  (let ((opam-site-lisp (expand-file-name ".opam/default/share/emacs/site-lisp" (getenv "HOME"))))
    (when (file-directory-p opam-site-lisp)
      (add-to-list 'load-path opam-site-lisp))
    (when (file-directory-p (expand-file-name "tuareg-site-file" opam-site-lisp))
      (load (expand-file-name"tuareg-site-file" opam-site-lisp)))
  ...
  (use-package merlin-eldoc
    :ensure t
    :config
    (evil-define-key* nil my/ocaml-map
      "l" '("locate identifier" . merlin-locate)
      "o" '("occurance" . merlin-occurrences)
      "t" '("display expr" . merlin-type-expr)
      "v" '("error check" . merlin-error-check)
      "x" '("error next" . merlin-error-next)
      "." '("get type" . merlin-type-enclosing)))
...
#+begin_src emacs-lisp
  (use-package zig-mode
    ...
    :config
    (with-eval-after-load 'evil
      (evil-define-key* nil my/zig-map
...
#+begin_src emacs-lisp
  (use-package go-mode
    ...
    :config
    (with-eval-after-load 'evil
      (evil-define-key* nil my/golang-map
      "a" '("code action" . eglot-code-actions)))
    (with-eval-after-load 'eglot
  ...
  (use-package go-eldoc
    :ensure t)
#+end_src
*** fish-mode :noexport:archive:disabled:external:
#+begin_src emacs-lisp :tangle no
