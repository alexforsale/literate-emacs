...
#+begin_src emacs-lisp
  (cond ((file-directory-p (expand-file-name "Sync/org" (getenv "HOME")))
  	  ...
  	  ((string-match-p "microsoft" (shell-command-to-string "uname -a"))
  	   (if (file-directory-p "/mnt/c/Users/alexf/Sync/org")
  		   (customize-set-variable '+config/org-directory "/mnt/c/Users/alexf/Sync/org"))))
#+end_src
...
#+begin_src emacs-lisp
  (with-eval-after-load 'evil
    (setopt my/e-map (make-sparse-keymap))
    (evil-define-key* '(normal visual) 'global (kbd "<leader>e") (cons "E" my/e-map)))
#+end_src
*** F
...
#+begin_src emacs-lisp
  (use-package doom-themes
    ...
    (cond ((string-equal "uganda" system-name)
          ...
          ((string-equal "zaire" system-name)
...
#+end_src
*** [[https://github.com/Alexander-Miller/treemacs][treemacs]] :external:
#+begin_src emacs-lisp
  ...
  (use-package treemacs-evil
    ...
    :after (treemacs evil)
    :config
    (evil-define-key* nil my/e-map
      (kbd "e") '("treemacs" . treemacs)))
  ...
  (use-package treemacs-icons-dired
    :ensure t
    :hook (dired-mode . treemacs-icons-dired-mode-enable-once))
...
#+begin_src emacs-lisp
  (use-package djangonaut
    :ensure t)
#+end_src
*** [[https://github.com/haskell/haskell-mode][haskell-mode]] :external:
#+begin_src emacs-lisp
