      ...
      (save-excursion
        (dolist (buf (buffer-list))
          ...
          (if (and (buffer-file-name) (buffer-modified-p))
              (basic-save-buffer)))))
    (add-hook 'auto-save-visited-mode-hook 'full-auto-save)
    (nconc
     auto-mode-alist
     '(("/LICENSE\\'" . text-mode)
       ("\\.log\\'" . text-mode)
...
#+end_src
*** autorevert :disabled:archive:noexport:
  ...
  (use-package savehist
    ...
    (savehist-additional-variables
     '(evil-jumps-history
       ...
       regexp-search-ring)))
#+end_src
*** recentf :disabled:archive:noexport:
#+name: recentf
#+begin_src emacs-lisp :tangle no
(use-package recentf
  :bind ("C-c f" . recentf)
  ...
  (use-package vertico-multiform
    ...
    (setq vertico-multiform-commands
          `((describe-symbol (vertico-sort-function . vertico-sort-alpha))
            ...
            (persp-switch-to-buffer* reverse)
...
**** cape :disabled:archive:noexport:
#+begin_src emacs-lisp :tangle no
  (use-package cape
...
#+begin_src emacs-lisp
  ...
  ;;   :config
  ;;   (pyvenv-mode +1)
  ;;   (defun +config/set-venv-python-interpreter-and-directories ()
  ;;     "Set correct Python interpreter and libraries."
  ;;     (interactive)
  ;;     (progn
  ;;       (setq python-shell-interpreter (concat pyvenv-virtual-env ".venv/bin/python3"))
  ;;       (add-to-list 'lsp-clients-python-library-directories (concat pyvenv-virtual-env ".venv/"))))

  ;;   (defun +config/unset-venv-python-interpreter-and-directories ()
  ;;     "Reset back Python interpreter and libraries"
  ;;     (interactive
  ;;      (progn
  ;;        (setq python-shell-interpreter (executable-find "python"))
  ;;        (setq 'lsp-clients-python-library-directories '("/usr")))))
  ;;   :hook ((pyvenv-post-activate . +config/set-venv-python-interpreter-and-directories)
  ;;          (pyvenv-post-deactivate . +config/unset-venv-python-interpreter-and-directories)))
...
#+begin_src emacs-lisp
  (use-package rustic
    ...
    ;;     (setq rustic-lsp-server (executable-find "rust-analyzer")
    ;;           lsp-rust-server nil
    ;;           lsp-rust-analyzer-server-command `(,(executable-find "rust-analyzer")))))
    )
#+end_src
