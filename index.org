...
For parts of /Emacs/ not covered by Evil[fn:6].
...
#+name: +config/user-modules-directory
#+begin_src emacs-lisp -n
...
A megapack of themes for GNU Emacs[fn:2]. I'm not the kind of guy who enjoys /[[https://wiki.installgentoo.com/index.php/GNU/Linux_ricing][ricing]]/, I look every once in a while for a nice colorscheme and then I just stick it everywhere else. Been a /solarized/ fans most of the time, now I'm trying /[[https://www.nordtheme.com/][nord]]/.
#+name: doom-themes
#+begin_src emacs-lisp -n
...
A fancy and fast mode-line inspired by minimalism design[fn:3]. I'm using their themes, why not the modeline as well? I used mostly the default settings apart from project detection and indent info for showing the current indentation style (useful when editing yaml files).
#+name: doom-modeline
#+begin_src emacs-lisp -n
...
A utility package to collect various Icon Fonts and propertize them within Emacs[fn:9].
#+name: all-the-icons
#+begin_src emacs-lisp -n
...
** dashboard :external:
An extensible emacs dashboard[fn:4].
...
#+end_src
** which-key :external:
Emacs package that displays available keybindings in popup[fn:8]. This is one of the top /Emacs/ packages that I must have in my configuration.
#+name: which-key
#+begin_src emacs-lisp -n
...
** helpful :external:
Since /Emacs/ is a self-documenting editor[fn:5]. It's certainly nice to have a more contextual help buffers.
...
#+end_src
* Shells
CLOSED: [2024-04-24 Wed 21:26]
:LOGBOOK:
- State "DONE"       from "TODO"       [2024-04-24 Wed 21:26]
- State "TODO"       from              [2024-04-23 Tue 22:57]
:END:
** eshell 
...
:LOGBOOK:
- State "DONE"       from "TODO"       [2024-04-24 Wed 21:26]
- State "TODO"       from              [2024-04-23 Tue 23:00]
:END:
** magit :external:
#+caption: /Emacs magit/
...
** magit-gptcommit
Magit commit with the help of gpt[fn:10].
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp -n
  ...
  (use-package password-store-otp
    :ensure (:host github :repo "volrath/password-store-otp.el" :branch "master" :tag "0.1.5")
    :defer t
...
#+begin_src emacs-lisp -n
  (use-package notmuch
    :ensure (:host github :repo "notmuch/notmuch" :tag "0.38.3")
...
#+begin_src emacs-lisp -n
  (use-package clj-refactor
    :ensure (:host github :repo "clojure-emacs/clj-refactor.el" :branch "master" :tag "v3.12.0")
    :defer t
...
#+begin_src emacs-lisp -n
  (use-package cperl-mode
    :ensure (:host github :repo "jrockway/cperl-mode")
    :defer t
...
*** header :noexport:
#+begin_src emacs-lisp -n
  ;;; config --- `Emacs' Custom initialization file -*- lexical-binding: t -*-
  ;;; Commentary:
  ;;; Code:
#+end_src
*** The configuration
...
* Footnotes
[fn:10] https://github.com/douo/magit-gptcommit 

[fn:9] https://github.com/domtronn/all-the-icons.el
[fn:8] https://github.com/justbur/emacs-which-key
[fn:7] https://orgmode.org/manual/Noweb-Reference-Syntax.html 
[fn:6] https://github.com/emacs-evil/evil-collection
[fn:5] https://www.emacswiki.org/emacs/SelfDocumentation 
[fn:4] https://github.com/emacs-dashboard/emacs-dashboard
[fn:3] https://github.com/seagle0128/doom-modeline
[fn:2] https://github.com/doomemacs/themes
