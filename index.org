...
#+begin_src emacs-lisp
  (use-package org-modern
    ...
    (setq
     ...
     org-hide-emphasis-markers t ; set to nil for easier editing
     org-ellipsis "…"
     ;; Agenda styling
